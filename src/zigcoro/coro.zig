...
const base = struct {
    ...
    extern fn libcoro_stack_swap(current: *base.Coro, target: *base.Coro) void;
    comptime {
    ...
    pub const Coro = packed struct {
        ...
        pub fn init(func: Func, stack: []align(base.stack_alignment) u8) !@This() {
        ...
        pub inline fn resumeFrom(self: *@This(), from: *@This()) void {
