...
pub fn code_gen(
    ...
    const parts = struct {
        ...
        const TNameTag = name ++ "AsmTag";
        const TNameParamUnion = name ++ "AsmParamUnion";
        const TNameReturnUnion = name ++ "AsmReturnUnion";
        ...
        fn generate() [:0]const u8 {
            ...
            const sfn_body = comptime comptimePrint(sfn_body_fmt, .{ comptime_decl_check, message_handler(), delegator_fn_str() });
