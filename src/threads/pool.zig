...
const prio = @import("thread_prio.zig");
...
fn worker_time_critical(pool: *Pool) void {
    prio.set_realtime_critical_highest() catch |e| {
        std.log.err("{}", .{e});
        return;
    };
